...
// ClientTimeoutException name
var CLIENT_TIMEOUT_EXCEPTION = 'ClientTimeoutException';
...
Connection.prototype.execute = function(query, args, callback) {
  ...
  var timeoutId = setTimeout(function() {
    ...
    err.name = CLIENT_TIMEOUT_EXCEPTION;
  ...
  async.whilst(
    ...
    function finished(err) {
      ...
      if (err) {
        ...
        callbackErr = new Error(errMsg);
        callbackErr.name = CLIENT_TIMEOUT_EXCEPTION;
